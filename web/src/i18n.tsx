...
const translations: Record<Language, TranslationMap> = {
  "zh-CN": {
    ...
    "status.heroReadyTitle": "服务运行正常",
    "status.heroNotReadyTitle": "服务需要完成设置",
    "status.heroReadyDescription": "API 已响应，账号凭据已验证，可以安全触发同步或等待自动任务。",
    "status.heroAuthDescription":
      "Web UI 已受保护，但 Dizzylab 登录信息尚未验证。请在设置中完成账号配置。",
    "status.heroSetupDescription":
      "请完成首次设置并验证 Dizzylab 账号；敏感凭据仅以已保存/未保存状态展示。",
    "status.startedAt": "开始时间",
    "status.noActiveJob": "当前没有正在运行的同步任务",
    "status.accountSecurity": "账号与凭据",
    "status.accounts": "账号数",
    "status.credentials": "凭据",
    "status.credentialsVerified": "已验证（内容已隐藏）",
    "status.credentialsRedacted": "未就绪（敏感内容不显示）",
    "status.configuration": "配置",
    "status.configured": "已配置",
    "status.notConfigured": "未配置",
    "status.noAccounts": "暂无已验证账号；保存凭据后会在这里显示账号名称和 UID。",
    "sync.title": "同步控制",
    ...
    "detail.giftMissing": "已配置特典下载，但本地缺少特典",
    "detail.duration": "时长",
  ...
  "en-US": {
    ...
    "status.heroReadyTitle": "Service is healthy",
    "status.heroNotReadyTitle": "Service needs setup",
    "status.heroReadyDescription":
      "The API is responding, account credentials are verified, and sync can run now or on schedule.",
    "status.heroAuthDescription":
      "The Web UI is protected, but Dizzylab login is not verified yet. Finish account setup in Settings.",
    "status.heroSetupDescription":
      "Complete first-time setup and verify Dizzylab accounts. Sensitive credentials are shown only as saved or missing.",
    "status.startedAt": "Started at",
    "status.noActiveJob": "No sync job is currently running",
    "status.accountSecurity": "Accounts and credentials",
    "status.accounts": "Accounts",
    "status.credentials": "Credentials",
    "status.credentialsVerified": "Verified (hidden)",
    "status.credentialsRedacted": "Not ready (redacted)",
    "status.configuration": "Configuration",
    "status.configured": "Configured",
    "status.notConfigured": "Not configured",
    "status.noAccounts": "No verified accounts yet. Saved accounts will show names and UIDs here.",
    ...
    "detail.giftMissing": "Gift download is configured, but the local gift is missing",
