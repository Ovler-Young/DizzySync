...
const translations: Record<Language, TranslationMap> = {
  "zh-CN": {
    ...
    "album.sync": "同步",
    "album.play": "播放",
    "album.noPlayableTracks": "此专辑没有可播放的本地曲目",
    "album.reload": "重新加载",
    "album.columns": "列",
    "album.tableView": "表格",
    "album.cardView": "卡片",
    "album.filterAll": "全部状态",
    "album.filterAllPlayable": "全部播放状态",
    "album.filterPlayable": "可播放",
    "album.filterNotPlayable": "不可播放",
    "album.filterSearchPlaceholder": "搜索标题、厂牌、ID 或标签",
  ...
  "en-US": {
    ...
    "album.sync": "Sync",
    "album.play": "Play",
    "album.noPlayableTracks": "This album has no playable local tracks",
    "album.reload": "Reload",
    "album.columns": "Columns",
    "album.tableView": "Table",
    "album.cardView": "Cards",
    "album.filterAll": "All local states",
    "album.filterAllPlayable": "All playback states",
    "album.filterPlayable": "Playable",
    "album.filterNotPlayable": "Not playable",
    "album.filterSearchPlaceholder": "Search title, label, ID, or tags",
